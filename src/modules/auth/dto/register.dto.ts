...
export class RegisterDto {
  ...
  @ApiProperty({ example: 'john_doe', description: 'Unique username (alphanum, 3-30 chars)' })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({ example: 'MySecurePass123!', description: 'Password (min 8 chars, must contain uppercase, lowercase, number)' })
  @IsString()
  @IsNotEmpty()
